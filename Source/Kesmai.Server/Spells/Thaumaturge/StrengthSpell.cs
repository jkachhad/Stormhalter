...
public class StrengthSpell : DelayedSpell
{
	private static SpellInfo _info = new SpellInfo(53, "Strength", typeof(StrengthSpell), 3);
	...
	{
		private StrengthSpell _spell;

		public InternalTarget(StrengthSpell spell) : base(flags: TargetFlags.Beneficial)
		{
			_spell = spell;
		}
