...
public class ScorpionRobe : Robe, ITreasure
{
	/// <inheritdoc />
	...
	/// Initializes a new instance of the <see cref="ScorpionRobe"/> class.
	/// </summary>
	public ScorpionRobe(Serial serial) : base(serial)
	{
	}
	...
	{
		yield return LocalizationEntry.Get(6200197); /* [a white robe with a black and silver scorpion.] */
