...
public class SerpentRobe : Robe, ITreasure
{
	/// <inheritdoc />
	...
	/// Initializes a new instance of the <see cref="SerpentRobe"/> class.
	/// </summary>
	public SerpentRobe(Serial serial) : base(serial)
	{
	}
	...
	{
		yield return LocalizationEntry.Get(6200183); /* [a black robe with a gold serpent.] */
