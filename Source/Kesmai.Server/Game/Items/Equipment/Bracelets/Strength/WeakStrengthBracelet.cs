...
public class WeakStrengthBracelet : StrengthBracelet, ITreasure
{
	...
	{
		yield return LocalizationEntry.Get(6200083); /* [a leather armband studded with nodules.] */

		if (Identified)
			yield return LocalizationEntry.Get(6250059); /* The bracelet contains a weak spell of Strength. */
	}
