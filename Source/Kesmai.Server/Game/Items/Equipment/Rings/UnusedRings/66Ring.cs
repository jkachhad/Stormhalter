...
{
	public partial class SixtySixRing : Ring, ITreasure
	{
		/// <summary>
		/// Gets the price.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="SixtySixRing"/> class.
		/// </summary>
		public SixtySixRing() : base(66)
		{
		}
		...
		/// Initializes a new instance of the <see cref="SixtySixRing"/> class.
		/// </summary>
		public SixtySixRing(Serial serial) : base(serial)
		{
		}
		...
		{
			entries.Add(new LocalizationEntry(6200000, 6200062)); /* [You are looking at] [a gold ring with a dazzling diamond nestled in a rosette of rubies.] */
