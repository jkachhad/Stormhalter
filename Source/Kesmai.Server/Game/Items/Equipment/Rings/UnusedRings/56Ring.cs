...
{
	public partial class FiftySixRing : Ring, ITreasure
	{
		/// <summary>
		/// Gets the price.
		/// </summary>
		...
		/// Initializes a new instance of the <see cref="FiftySixRing"/> class.
		/// </summary>
		public FiftySixRing(Serial serial) : base(serial)
		{
		}
		...
		{
			entries.Add(new LocalizationEntry(6200000, 6200052)); /* [You are looking at] [a heavy lead ring.] */
