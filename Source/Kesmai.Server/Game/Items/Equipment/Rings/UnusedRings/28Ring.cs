...
{
	public partial class TwentyEightRing : Ring, ITreasure
	{
		/// <summary>
		/// Gets the price.
		/// </summary>
		...
		{
			entries.Add(new LocalizationEntry(6200000, 6200059)); /* [You are looking at] [a ring made of a strange pink substance.] */
