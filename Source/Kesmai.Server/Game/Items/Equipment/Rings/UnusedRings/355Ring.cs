...
{
	public partial class ThreeFiftyFiveRing : Ring, ITreasure
	{
		/// <summary>
		/// Gets the price.
		/// </summary>
		...
		/// </summary>
		public ThreeFiftyFiveRing() : base(355)
		{
		}
		...
		/// Initializes a new instance of the <see cref="ThreeFiftyFiveRing"/> class.
		/// </summary>
		public ThreeFiftyFiveRing(Serial serial) : base(serial)
		{
		}
		...
		{
			entries.Add(new LocalizationEntry(6200000, 6200326)); /* [You are looking at] [a platinum ring with a jet black pearl set in it.] */
