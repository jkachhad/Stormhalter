...
public class SixtyEightRing : Ring, ITreasure
{
	/// <summary>
	/// Gets the price.
	/// </summary>
	...
	{
		yield return LocalizationEntry.Get(6200322); /* [a large silver ring with a deep black stone set among rubies.  The stone appears to hold a dark power.] */
