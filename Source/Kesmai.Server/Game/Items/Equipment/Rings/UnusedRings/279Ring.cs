...
public class TwoSeventyNineRing : Ring, ITreasure
{
	/// <summary>
	/// Gets the price.
	/// </summary>
	...
	{
		yield return LocalizationEntry.Get(6200064); /* [a large silver ring with a deep black stone set among rubies.  There is an eerie glow coming from the stone.] */
