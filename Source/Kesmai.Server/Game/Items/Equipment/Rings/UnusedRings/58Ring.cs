...
{
	public partial class FiftyEightRing : Ring, ITreasure
	{
		/// <summary>
		/// Gets the price.
		/// </summary>
		...
		{
			entries.Add(new LocalizationEntry(6200000, 6200028)); /* [You are looking at] [a gold ring with a beautiful emerald.] */
