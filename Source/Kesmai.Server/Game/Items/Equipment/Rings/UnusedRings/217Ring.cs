...
{
	public partial class TwoSeventeenRing : Ring, ITreasure
	{
		/// <summary>
		/// Gets the price.
		/// </summary>
		...
		/// </summary>
		public TwoSeventeenRing() : base(217)
		{
		}
		...
		{
			entries.Add(new LocalizationEntry(6200000, 6200053)); /* [You are looking at] [a small gold ring.] */
