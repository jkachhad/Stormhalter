...
namespace Kesmai.Server.Items
{
	public partial class ThreeFiftyThreeRing : Ring, ITreasure
	{
		...
		/// </summary>
		public ThreeFiftyThreeRing() : base(353)
		{
		}
		...
		/// Initializes a new instance of the <see cref="ThreeFiftyThreeRing"/> class.
		/// </summary>
		public ThreeFiftyThreeRing(Serial serial) : base(serial)
		{
		}
		...
		{
			entries.Add(new LocalizationEntry(6200000, 6200324)); /* [You are looking at] [a gold ring with a small black pearl set in it.] */
