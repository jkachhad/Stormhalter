...
{
	public partial class TwoNinetyFourRing : Ring, ITreasure
	{
		/// <summary>
		/// Gets the price.
		/// </summary>
		...
		{
			entries.Add(new LocalizationEntry(6200000, 6200055)); /* [You are looking at] [a brass ring engraved with undecipherable symbols.] */
