...
public class CrashingWavesRing : Ring, ITreasure
{
	...
	{
		yield return LocalizationEntry.Get(6200283); /* [a ring with crashing ocean waves.] */

		if (Identified)
			yield return LocalizationEntry.Get(6250129); /* The ring contains a spell of Water Walking. */
	}
